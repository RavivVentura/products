...
import requests
from common.google_drive.read_data_from_spreadsheet import get_all_twitter_handles_and_folder_id_from_spredsheet
...
def index(request):
    ...
    if request.method == "POST" and 'all_companies' in request.POST:
        twitter_handles = get_all_twitter_handles_and_folder_id_from_spredsheet('Webinars_to_refresh',2)
